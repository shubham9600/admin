							...
							<div class="lh-card-content label-card">
								<div class="title">
									<div class="growth-numbers">
										...
										<h5><span data-bs-toggle="tooltip" aria-label="Available" data-bs-original-title="Available">45</span></h5>
									</div>
			...
			<div class="lh-tools-detail">
				<div class="lh-tools-block">
					...
					<div class="lh-tools-info">
						<div class="lh-tools-item mode" data-lh-mode-tool="light">
							<img src="assets/img/tools/light.png" alt="light">
							<p>light</p>
						</div>
						<div class="lh-tools-item mode active" data-lh-mode-tool="dark">
				...
				<div class="lh-tools-block">
					<h3>Sidebar</h3>
					<div class="lh-tools-info">
						<div class="lh-tools-item sidebar" data-sidebar-mode-tool="light">
							<img src="assets/img/tools/side-light.png" alt="light">
							<p>light</p>
						</div>
						<div class="lh-tools-item sidebar active" data-sidebar-mode-tool="dark">
...
<!-- Mirrored from maraviyainfotech.com/projects/luxurious-html-v22/admin/dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Feb 2024 13:00:49 GMT -->
</html>